...
export const Subjects: SecSubjectsType = {
    gen: {
        first: [
            ...
            { name: "اللغة الانجليزية", weight: 5 },
            { name: "الكيمياء", weight: 5 },
            { name: "الاحياء", weight: 4 },
    ...
    eng: {
        first: [
            ...
            { name: "الكيمياء", weight: 5 },
            { name: "الاحياء", weight: 4 },
            { name: "فيزياء", weight: 4 },
            { name: "كفايات لغوية", weight: 4 },
        ...
        second: [
            ...
            { name: "الاحياء", weight: 4 },
            { name: "التوحيد", weight: 2 },
            { name: "علم البيانات", weight: 2 },
            { name: "انترنت الاشياء", weight: 4 },
            { name: "اللياقة والثقافة الصحية", weight: 3 },
            { name: "النشاط", weight: 2 },
            { name: "السلوك", weight: 1 },
            { name: "المواظبة", weight: 5 }
    ...
    hlth: {
        first: [
            ...
            { name: "الكفايات اللغوية", weight: 4 },
            { name: "التقنية الرقمية", weight: 4 },
            { name: "مبادئ العلوم الصحية", weight: 3 },
            { name: "النشاط", weight: 2 },
            { name: "السلوك", weight: 1 },
            { name: "المواظبة", weight: 5 }
        ],
        second: [
            ...
            { name: "الفيزياء", weight: 4 },
            { name: "التوحيد", weight: 2 },
            { name: "مبادئ العلوم الصحية", weight: 2 },
            { name: "اللياقة والثقافة الصحية", weight: 3 },
            { name: "النشاط", weight: 2 },
            { name: "السلوك", weight: 1 },
            { name: "المواظبة", weight: 5 }
    ...
    biz: {
        first: [
            ...
            { name: "التوحيد", weight: 2 },
            { name: "الكفايات اللغوية", weight: 4 },
            { name: "صناعة القرار في الاعمال", weight: 5 },
            { name: "مقدمة في الاعمال", weight: 4 },
            { name: "الادارة المالية", weight: 3 },
            { name: "التقنية الرقمية", weight: 4 },
            { name: "الفنون", weight: 2 },
            { name: "النشاط", weight: 3 },
            { name: "السلوك", weight: 1 },
            { name: "المواظبة", weight: 5 }
        ],
        second: [
            ...
            { name: "الدراسات اللغوية", weight: 3 },
            { name: "صناعة القرار في الاعمال", weight: 4 },
            { name: "مقدمة في الاعمال", weight: 3 },
            { name: "مبادئ الاقتصاد", weight: 3 },
            { name: "الادارة المالية", weight: 3 },
            { name: "التاريخ", weight: 3 },
            { name: "اللياقة الصحية والبدنية", weight: 3 },
            { name: "النشاط", weight: 3 },
            { name: "السلوك", weight: 1 },
            { name: "المواظبة", weight: 5 }
        ]
    ...
    shar: {
        first: [
            ...
            { name: "اللغة الانجليزية", weight: 5 },
            { name: "توحيد 1", weight: 2 },
            { name: "الحديث", weight: 2 },
            { name: "القراءات 1", weight: 4 },
            { name: "الكفايات اللغوية", weight: 4 },
            { name: "التقنية الرقمية", weight: 4 },
            { name: "اللياقة والثقافة الصحية", weight: 3 },
            { name: "النشاط", weight: 3 },
        ...
        second: [
            { name: "القران الكريم", weight: 5 },
            { name: "اللغة الانجليزية", weight: 5 },
            { name: "توحيد 2", weight: 2 },
            { name: "القراءات 2", weight: 3 },
            { name: "علوم القران", weight: 4 },
            { name: "التفسير", weight: 2 },
            { name: "الدراسات اللغوية", weight: 3 },
            { name: "التاريخ", weight: 3 },
            { name: "الفنون", weight: 2 },
