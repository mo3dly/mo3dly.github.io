                                ...
                                {(open, toggle) => (
                                    <>
                                        ...
                                        <Faq.Answer isOpen={open}>
                                            تقوم وزارة التعليم بحساب المعدل للمرحلة المتوسطة عن طريق ضرب درجة كل مادة في عدد حصصها الأسبوعية، ثم جمع نواتج الضرب لجميع المواد. بعد ذلك يُقسَم المجموع على إجمالي عدد الحصص الأسبوعية
