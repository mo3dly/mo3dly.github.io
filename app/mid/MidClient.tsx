...
const grades = [
    { href: "/grades/7", label: "أول متوسط", num: "١" },
    { href: "/grades/8", label: "ثاني متوسط", num: "٢" },
    { href: "/grades/9", label: "ثالث متوسط", num: "٣" },
];
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        itemListElement: [
                            ...
                            { "@type": "ListItem", position: 2, name: "المرحلة المتوسطة", item: "https://mo3dly.github.io/mid" },
                        ],
                    }),
                }}
            />
                                    ...
                                    {(open, toggle) => (
                                        <>
                                            <Faq.Question isOpen={open} onClick={toggle}>
                                                كيف يتم حساب المعدل للمرحلة المتوسطة؟
                                            </Faq.Question>
                                            <Faq.Answer isOpen={open}>
                                                تقوم وزارة التعليم بحساب المعدل للمرحلة المتوسطة عن طريق ضرب درجة كل مادة في عدد حصصها الأسبوعية، ثم جمع نواتج الضرب لجميع المواد. بعد ذلك يُقسَم المجموع على إجمالي عدد الحصص الأسبوعية — وسوّينا حاسبة معدلي عشان تختصر عليك هذي الحسابات 😉
                                            </Faq.Answer>
                                        </>
                                    )}
                                </Faq.Item>
