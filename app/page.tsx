  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://mo3dly.github.io/" />
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8 text-center" style={{ border: '1px solid #e5e7eb' }}>
              <div className="mb-6">
                ...
                <h2 className="text-xl md:text-2xl font-bold mb-3" style={{ color: '#33365B' }}>
                  احسب معدلك الدراسي مع معدلي
                </h2>
                <p className="text-base md:text-lg mb-6" style={{ color: '#6c757d' }}>
                  نحسب معدلك الدراسي للمرحلة المتوسطة والثانوية بدقة وفق نظام وزارة التعليم بالسعودية
                </p>
              </div>

              <button
                onClick={openGradeDialog}
                className="w-full md:w-auto px-8 py-4 rounded-xl font-bold text-lg text-white shadow-lg hover:shadow-xl transition-all duration-300"
                style={{
                    ...
                    >
                      <div className="flex items-center">
                        ...
                        <div className="text-right">
                          ...
                          <p className="text-sm" style={{ color: '#6c757d' }}>ندعم جميع مسارات الثانوية</p>
                        </div>
                      </div>
                      <span style={{ color: '#6c757d' }}>→</span>
                    </button>
